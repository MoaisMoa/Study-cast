...
export function MyStudyCardMobile({ room, onCardClick, selectMode, selected, onToggle, disabled = false }: MyStudyCardMobileProps) {
  const T = useT();
  ...
  return (
    <div
      ...
      style={{
        borderRadius: T.radius, overflow: "hidden", cursor: disabled ? "not-allowed" : "pointer", position: "relative",
    ...
    >
      ...
      <div style={{ position: "relative", aspectRatio: "4/3", overflow: "hidden" }}>
        <img src={room.img} alt={room.title} style={{ width: "100%", height: "100%", objectFit: "cover", filter: disabled ? "grayscale(0.8) brightness(0.9)" : "none" }} />
